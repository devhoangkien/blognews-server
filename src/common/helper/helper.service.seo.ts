...
import { getMessageFromAxiosError } from '@app/common/transformers/error.transformer'
...
export class SeoService {
  ...
  private pingBaidu(action: SEOAction, urls: string[]): void {
    ...
    this.httpService.axiosRef
      ...
      .then((response) => {
        Logger.log(`[SEO]`, `${actionText} succeed:`, urls, response.statusText)
      })
      .catch((error) => {
    ...
    this.googleService
      ...
      .then((credentials) => {
        return this.httpService.axiosRef
          ...
          .then((response) => {
            Logger.log(`[SEO]`, `${actionText} succeed:`, url, response.statusText)
          })
