...
import { ResponseStatus, HttpResponseError, ExceptionInfo } from '@app/common/interfaces/response.interface'
import { UNDEFINED } from '@app/common/constants/value.constant'
import { isDevEnv } from '@app/app.environment'

/**
 * @class HttpExceptionFilter
 * @classdesc Chặn tất cả các ngoại lệ được đưa ra trên toàn cầu và mọi lỗi sẽ được chuẩn hóa tại đây để xuất ra HttpErrorResponse
 */
@Catch()
