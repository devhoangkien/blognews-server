 ...
 * @description Used to convert a basic Typegoose model to Model and Provider, and model injector
...
import { DB_CONNECTION_TOKEN, DB_MODEL_TOKEN_SUFFIX } from '@app/common/constants/system.constant'
